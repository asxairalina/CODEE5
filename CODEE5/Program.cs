//ПЯТЬ// наследование - ключевой прицнцип ООП, заключается в том, что позволяет одному классу унаследовать функциональность другого
...
//события сигнализируют системе, что произошло какое-либо действие; события используются для того, чтобы отследить эти действия и являются указателями на делегаты и использует заданный 
//в делегат тип данных как выводные данные
